...
| H-ARMY-RAID | Up to 3 squads of 3 raiders leave the home group to hunt enemy extractors: the nearest remembered one not within 550 of a remembered armed building, else an unvisited metal spot on the enemy half; move there, fight on arrival; empty or unreached places rest 3 minutes | `raid.rs` | K-army-we-never-raid | active; nw-medium-raids 0-12, extractor kills 3.1 -> 4.9 a game: no demonstrated benefit |
