...
| `cmd` | ticks with commands | `c`: [["build", unit, def, x, z] or ["build", unit, def] for a factory, ["move", unit, x, z], ["fight", unit, x, z], ["stop", unit], ["repeat", unit, 0 or 1], ["guard", unit, target unit], ["reclaim", unit, x, z, radius]] |
